 ...
 * 
 */
public class BMRatingCalculator {
	 ...
	 * @param results
	 */
	public void updateRatings(BMRatingPeriodResults results) {
		for ( BMRating player : results.getParticipants() ) {
	 ...
	 * @param results
	 */
	private void calculateNewRating(BMRating player, List<BMResult> results) {
	 ...
	 * @return
	 */
	private double v(BMRating player, List<BMResult> results) {
		double v = 0.0;
