...
public class BMRating {
	 ...
	 */
	public BMRating(String uid, BMRatingCalculator ratingSystem) {
		this.uid = uid;
	...
	/*public BMRating(String uid, BMRatingCalculator ratingSystem, double initRating, double initRatingDeviation, double initVolatility) {
		this.uid = uid;
	...
	public double getGlicko2Rating() {
		return BMRatingCalculator.convertRatingToGlicko2Scale(this.rating);
	}
	...
	public void setGlicko2Rating(double rating) {
		this.rating = BMRatingCalculator.convertRatingToOriginalGlickoScale(rating);
	}
	...
	public double getGlicko2RatingDeviation() {
		return BMRatingCalculator.convertRatingDeviationToGlicko2Scale( ratingDeviation );
	}
	...
	public void setGlicko2RatingDeviation(double ratingDeviation) {
		this.ratingDeviation = BMRatingCalculator.convertRatingDeviationToOriginalGlickoScale( ratingDeviation );
	}
