...
public class BMResult {
	...
	private BMRating winner;
	private BMRating loser;
	 ...
	 * @param loser
	 */
	public BMResult(BMRating winner, BMRating loser) {
	 ...
	 */
	public boolean participated(BMRating player) {
	 ...
	 */
	public double getScore(BMRating player) throws IllegalArgumentException {
		double score;
	 ...
	 * @return opponent
	 */
	public BMRating getOpponent(BMRating player) {
		BMRating opponent;
